...
#change hostname
hostname data-1-2
sed -i '2c HOSTNAME=data-1-2' /etc/sysconfig/network
...
#add static route
route add -host 10.0.0.221 dev eth1
echo '/sbin/route  add -host 10.0.0.221 dev eth1' >>/etc/rc.local 
...
echo '10.128.231.222' >>/var/www/html/index.html
